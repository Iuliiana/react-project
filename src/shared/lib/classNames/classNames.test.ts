...
describe('classNames', () => {
    ...
    test('add additional', () => {
        expect(classNames('active', {}, ['color-red', 'color-blue'])).toBe(
    ...
    test('add additional and mods true', () => {
        expect(
            classNames('active', { hovered: true, selected: true }, [
                'color-red',
                'color-blue',
            ]),
    ...
    test('add additional and mods false', () => {
        expect(
            classNames('active', { hovered: true, selected: false }, [
                'color-red',
            ]),
    ...
    test('add null value', () => {
        expect(
            classNames('active', { hovered: undefined }, [
                'color-red',
                undefined,
            ]),
